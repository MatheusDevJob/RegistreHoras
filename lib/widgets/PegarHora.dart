...
/// See also:
///
/// * [showTimePicker], a function that shows a [PegarHora] and returns
...
/// [Navigator.pop].
///
/// Use [showTimePicker] to show a dialog already containing a [PegarHora].
class PegarHora extends StatefulWidget {
  ...
  */
  ...
  /// Restoration ID to save and restore the state of the [PegarHora].
  ///
